...
export function UploadDataWidget({onCancel, dispatch}) {
  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        ...
        {step === STEPS.UPLOAD_FILE ? <UploadFileStep {...uploadProps}/> : null}
        {step === STEPS.CHOOSE_COLUMNS ? <ClassifyColumnsStep {...classifyColsProps} /> : null}
    </Modal>
  );
}
